...
- [x] T025 Run the focused/full benchmark gates and record evidence and deliberate nonclaims in the quickstart — Evidence: 49 focused and 359 container-free benchmark tests pass; compiler, targeted-format, and diff gates pass with the existing NU1903 advisory disclosed in `quickstart.md`.
