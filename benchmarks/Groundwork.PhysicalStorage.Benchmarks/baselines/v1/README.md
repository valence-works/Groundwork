...
Before any baseline can be considered, issue #50 must execute the 1K/100K/1M matrix for one named,
reviewed payload profile and the ratified 10% indexed-query acceptance and 50%
scan-characterization query-selectivity shapes. It must also supply exact-HEAD live evidence for
